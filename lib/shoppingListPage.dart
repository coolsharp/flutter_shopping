...
class ShoppingList extends StatefulWidget {
  const ShoppingList(
      {super.key, required this.category, required this.keyword});
...
class _ShoppingListState extends State<ShoppingList> {
  ...
  void _firstLoad() async {
    ...
    try {
      String url =
          '${_baseUrl}products/category/${widget
          .category}?limit=$_limit&skip=$_skip';
      if ('all' == widget.category) {
        url = '${_baseUrl}products?limit=$_limit&skip=$_skip';
      }
      if (null != widget.keyword && widget.keyword.isNotEmpty) {
        url =
        '${_baseUrl}products/search?q=${widget
            .keyword}&limit=$_limit&skip=$_skip';
      }
